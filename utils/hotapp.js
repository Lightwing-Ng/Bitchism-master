!function () {
    ...
    function s(e, t) {
        ...
        var n = e.__route__, o = setInterval(function () {
            ...
            var r = I + "/data/wechat/param",
                a = {hotAppKey: A, page: n, openId: e, hotAppUUID: g.getHotAppUUID(), paraInfo: t};
            ...
            e[t] = function (e) {
                ...
                if ("onError" == t) {
                    ...
                    if (v.isArray(i) && v.isObject(i[1])) {
                        ...
                        var u = i[0], c = i[1], s = ["getStorageSync:fail"];
    ...
    var l = function () {
        ...
        var o = Object.prototype.toString, r = Object.prototype.hasOwnProperty, a = Array.prototype.slice,
            p = function () {
                function t(t, o) {
        ...
        var O = {
            ...
            debugarr: [],
            hotAppDebug: !1
        }, U = require("./hotapp-conf"), b = l.extendObj(O, U), x = l.assert;
        x.shouldBe("object", b);
    ...
    }(), d = g.log, v = l.assert, A = g.getHotAppKey(), I = g.getHotAppHost(), m = App;
    App = function (t) {
