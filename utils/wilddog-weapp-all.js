!function (t, e) {
    ...
    return function (t) {
        ...
        }, i = r(3), a = r(17), c = r(21)("engine.io-client:socket"), u = r(32), h = r(6), p = r(33), l = r(18);
        t.exports = n, n.priorWebsocketSuccess = !1, a(n.prototype), n.protocol = h.protocol, n.Socket = n, n.Transport = r(5), n.transports = r(3), n.parser = r(6), n.prototype.createTransport = function (t) {
                ...
                p || (c('probe transport "%s" opened', t), h.send([{
                    ...
                    if (!p) if ("pong" === e.type && "probe" === e.data) {
                        ...
                        n.priorWebsocketSuccess = "websocket" === h.name, c('pausing current transport "%s"', l.transport.name), l.transport.pause(function () {
                            p || "closed" !== l.readyState && (c("changing transport and sending upgrade packet"), u(), l.setTransport(h), h.send([{type: "upgrade"}]), l.emit("upgrade", h), h = null, l.upgrading = !1, l.flush())
                        })
                    } else {
            ...
            var h = this.createTransport(t, {probe: 1}), p = !1, l = this;
        ...
        function n(t) {
            var e, r = !1, n = !1, o = !1 !== t.jsonp;
            if (global.location) {
                var s = "https:" === location.protocol, i = location.port;
        ...
        var o = r(5), s = r(6), i = r(18), a = r(19), c = r(20), u = r(21)("engine.io-client:websocket"),
            h = r(24).WebSocket;
        ...
        function o(t, r, n) {
            ...
            var o = t.data, s = new Uint8Array(o), i = new Uint8Array(1 + o.byteLength);
            i[0] = v[t.type];
        ...
        var u, h = r(7), p = r(8), l = r(10), f = r(11), d = r(12);
        ...
        var v = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, b = h(v),
            w = {type: "error", data: "parser error"}, k = r(16);
        e.encodePacket = function (t, e, r, s) {
            ...
            var s = new Uint8Array(t), o = s[0], i = l(t, 1);
            return k && "blob" === r && (i = new k([i])), {type: b[o], data: i}
        ...
        function n(t) {
            function e(t) {
                ...
                if (s(t)) {
                    ...
                    t.toJSON && (t = t.toJSON());
                    for (var n in t) if (Object.prototype.hasOwnProperty.call(t, n) && e(t[n])) return !0
                }
                return !1
            }
        ...
        (function (t) {
            ...
            !function (s) {
                ...
                function f(t) {
                    ...
                    for (var e, r = []; (e = l()) !== !1;) r.push(e);
                    return a(r)
                }

                var d = "object" == o(e) && e, y = "object" == o(t) && t && t.exports == d && t,
                    g = "object" == ("undefined" == typeof global ? "undefined" : o(global)) && global;
                g.global !== g && g.window !== g || (s = g);
                var m, v, b, w = String.fromCharCode, k = {version: "1.0.0", encode: h, decode: f};
                if ("object" == o(r(14)) && r(14)) n = function () {
                    return k
                }.call(e, r, e, t), !(void 0 !== n && (t.exports = n)); else if (d && !d.nodeType) if (y) y.exports = k; else {
        ...
        !function () {
            ...
            e.encode = function (e) {
                var r, n = new Uint8Array(e), o = n.length, s = "";
                ...
                var e, n, o, s, i, a = .75 * t.length, c = t.length, u = 0;
        ...
        "use strict";
        var n = r(25);
        t.exports = {WebSocket: n}, null == navigator && (navigator = {}, navigator.userAgent = "WeApp")
    }, function (t, e, r) {
        "use strict";
        ...
        t.exports = function () {
            ...
            function r(t, e, r) {
                var n, o, s;
                if (u.call(t, e)) for (r.target = t, n = t[e].slice(0), s = 0; s < n.length; s++) o = n[s], "function" == typeof o ? o.call(t, r) : "function" == typeof o.handleEvent && o.handleEvent(r)
            }
            ...
            var o = "@@", s = {}, i = {configurable: !0, value: null}, a = Object.defineProperty || function (t, e, r) {
                t[e] = r.value
        ...
        var d = /^([a-z0-9.+-]+:)/i, y = /:[0-9]*$/, g = ["<", ">", '"', "`", " ", "\r", "\n", "\t"],
            m = ["{", "}", "|", "\\", "^", "`"].concat(g), v = ["'"].concat(m), b = ["%", "/", "?", ";", "#"].concat(v),
            w = ["/", "?", "#"], k = 255, S = /^[a-z0-9A-Z_-]{0,63}$/, x = /^([a-z0-9A-Z_-]{0,63})(.*)$/,
            A = {javascript: !0, "javascript:": !0}, C = {javascript: !0, "javascript:": !0}, B = {
                http: !0,
                https: !0,
                ftp: !0,
                gopher: !0,
        ...
        n.prototype.parse = function (t, e, r) {
            ...
            if (!C[o] && (i || o && !B[o])) {
                ...
                if (!g) for (var m = this.hostname.split(/\./), u = 0, P = m.length; u < P; u++) {
                    var j = m[u];
                    if (j && !j.match(S)) {
                        for (var E = "", U = 0, L = j.length; U < L; U++) E += j.charCodeAt(U) > 127 ? "x" : j[U];
                        if (!E.match(S)) {
                            var T = m.slice(0, u), I = m.slice(u + 1), q = j.match(x);
                ...
                var z = this.port ? ":" + this.port : "", N = this.hostname || "";
            ...
            if (!A[s]) for (var u = 0, P = v.length; u < P; u++) {
                var _ = v[u], H = encodeURIComponent(_);
            ...
            if (J !== -1 ? (this.search = n.substr(J), this.query = n.substr(J + 1), e && (this.query = O.parse(this.query)), n = n.slice(0, J)) : e && (this.search = "", this.query = {}), n && (this.pathname = n), B[s] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                var z = this.pathname || "", M = this.search || "";
                this.path = z + M
            }
            ...
            if (t.protocol && t.protocol !== r.protocol) {
                ...
                if (r.protocol = t.protocol, t.host || C[t.protocol]) r.pathname = t.pathname; else {
                ...
                if (r.search = t.search, r.query = t.query, r.host = t.host || "", r.auth = t.auth, r.hostname = t.hostname || t.host, r.port = t.port, r.pathname || r.search) {
                    var s = r.pathname || "", i = r.search || "";
                    r.path = s + i
                }
                return r.slashes = r.slashes || t.slashes, r.href = r.format(), r
            }
            var a = r.pathname && "/" === r.pathname.charAt(0),
                u = t.host || t.pathname && "/" === t.pathname.charAt(0), l = u || a || r.host && t.pathname, f = l,
                d = r.pathname && r.pathname.split("/") || [], o = t.pathname && t.pathname.split("/") || [],
        ...
        (function (t) {
            ...
            !function (s) {
                ...
                function d(t) {
                    var e, r, n, o, s, a, c, u, l, d, y = [], g = t.length, m = 0, v = E, b = j;
                ...
                function y(t) {
                    ...
                    for (n = o = w.length, o && w.push(U); n < g;) {
                        ...
                        for (m = n + 1, c - e > D((x - r) / m) && i("overflow"), r += (c - e) * m, e = c, a = 0; a < g; ++a) if (y = t[a], y < e && ++r > x && i("overflow"), y == e) {
                ...
                var v = "object" == o(e) && e && !e.nodeType && e, b = "object" == o(t) && t && !t.nodeType && t,
                    w = "object" == ("undefined" == typeof global ? "undefined" : o(global)) && global;
                w.global !== w && w.window !== w && w.self !== w || (s = w);
                var k, S, x = 2147483647, A = 36, C = 1, B = 26, O = 38, P = 700, j = 72, E = 128, U = "-", L = /^xn--/,
                    T = /[^\x20-\x7E]/, I = /[\x2E\u3002\uFF0E\uFF61]/g, q = {
                        overflow: "Overflow: input needs wider integers to process",
                        "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                        "invalid-input": "Invalid input"
                    }, R = A - C, D = Math.floor, M = String.fromCharCode;
                if (k = {
                    version: "1.3.2",
                    ...
                    return k
                }.call(e, r, e, t), !(void 0 !== n && (t.exports = n)); else if (v && b) if (t.exports == v) b.exports = k; else for (S in k) k.hasOwnProperty(S) && (v[S] = k[S]); else s.punycode = k
            }(void 0)
        }).call(e, r(13)(t))
    }, function (t, e, r) {
        "use strict";
        ...
        t.exports = function (t, e, n, o) {
            ...
            a > 0 && c > a && (c = a);
            for (var u = 0; u < c; ++u) {
                var h, p, l, f, d = t[u].replace(i, "%20"), y = d.indexOf(n);
        ...
        t.exports = function (t) {
            var e = t, o = t.indexOf("["), s = t.indexOf("]");
...
(function (ns) {
    ...
    ns.wrapper = function (goog, wd) {
        ...
        Da.prototype.open = function (a, b, c) {
            var d = {Accept: "application/json;text/plain"};
            Ea(d, this.options.headers);
            a = {
                url: a, method: this.options.method.toUpperCase(), header: d, success: function (a) {
        ...
        function Ja() {
            var a = document.location.hash, b = "";
            try {
                var a = a.replace("#", ""), c = ua(a);
        ...
        function Qa(a, b, c) {
            wx.request({
                url: b, method: "POST", header: {Accept: "application/json;text/plain"}, success: function (a) {
        ...
        function Pa(a) {
            wx.getUserInfo({
                success: function (b) {
                    a(null, {rawData: b.rawData, signature: b.signature})
                }, fail: function () {
        ...
        function Kb(a, b, c) {
            if (a.Z == Jb) {
                ...
                var d;
                a:{
                    var e = c, f = a.Mg, g = a.Ng;
                    if (e instanceof Ib) Vb(e, Qb(f || aa, g || null, a)), d = !0; else {
                        var k;
                        if (e) try {
                            k = !!e.$goog_Thenable
                        } catch (m) {
        ...
        function Ub(a, b, c, d) {
            if (c == Nb && b.gc && !b.Uc) for (; a && a.fd; a = a.Ba) a.fd = !1;
            if (b.u) b.u.Ba = null, Zb(b, c, d); else try {
        ...
        function dc() {
            this.$e = {WxHttp: Da, WxImplicit: Oa};
            ...
            a.prototype.bindAsArray = function (a, e, f) {
                ...
                var k = [], l = {
                    child_added: function (a, e) {
                        ...
                        var e = b(k, a.key()), e = k.splice(e, 1);
                ...
                }, m = ["child_added", "child_removed", "child_moved", "child_changed"], L = new x;
                bc(L.m);
                ...
                if (null != a[".bindWilddogFuncs"]) {
                    ...
                    if (null != c && "object" == typeof c) {
                        for (var d = ["child_added",
                            "child_removed", "child_moved", "child_changed", "value"], e = 0; e < d.length; e++) {
                            var l = d[e];
        ...
        hc.prototype.update = function (a, b) {
            if (null != a) {
                ...
                for (var c = b - this.hb, d = 0, e = this.Wd, f = this.$b; d < b;) {
                    if (0 == f) for (; d <= c;) ic(this, a, d), d += this.hb;
                    if (q(a)) for (; d < b;) {
                    ...
                    } else for (; d < b;) if (e[f] = a[d], ++f, ++d, f == this.hb) {
                        ic(this, e);
                        f = 0;
                        break
                    }
        ...
        hc.prototype.digest = function () {
            ...
            ic(this, this.Wd);
            for (c = b = 0; 5 > c; c++) for (var d = 24; 0 <= d; d -= 8) a[b] = this.U[c] >> d & 255, ++b;
            return a
        };
        var jc = null, kc = null;
        ...
        function rc(a) {
            ...
            for (d = 0; d < b.length; d += 3) {
                var f = b[d], g = (e = d + 1 < b.length) ? b[d + 1] : 0, k = d + 2 < b.length, l = k ? b[d + 2] : 0,
                    m = f >> 2, f = (f & 3) <<
                    4 | g >> 4, g = (g & 15) << 2 | l >> 6, l = l & 63;
                k || (l = 64, e || (g = 64));
        ...
        function sc(a) {
            for (var b = "", c = 0; c < arguments.length; c++) var d = arguments[c], e = da(d), b = "array" == e || "object" == e && "number" == typeof d.length ? b + sc.apply(null, arguments[c]) : "object" === typeof arguments[c] ? b + u(arguments[c]) : b + arguments[c], b = b + " ";
            return b
        }
        ...
        function La(a) {
            ...
            return {host: b, port: k, domain: c, Jg: d, Hb: f, scheme: g, Db: e}
        }
        ...
        function Cc(a, b) {
            if (ea(a)) for (var c = 0; c < a.length; ++c) b(c, a[c]); else w(a, b)
        }
        ...
        Gc.prototype.Ab = function (a, b, c) {
            Hc(this, a);
            this.Ec[a] = this.Ec[a] || [];
            this.Ec[a].push({tc: b, context: c});
            (a = this.ge(a)) && b.apply(c, a)
        };
        Gc.prototype.fc = function (a, b, c) {
            Hc(this, a);
            a = this.Ec[a] || [];
            for (var d = 0; d < a.length; d++) if (a[d].tc === b && (!c || c === a[d].context)) {
                a.splice(d, 1);
                break
            }
        };
        ...
        D.prototype.Qf = function (a, b) {
            var c = !0, d;
            for (d in Jc) if (Jc.hasOwnProperty(d) && Jc[d] === a) {
                c = !1;
                break
            }
        ...
        var Jc = {gb: "authStateChanged", Ie: "authTokenExpired"};
        D.prototype.qb = Jc;
        ...
        E.prototype.Og = function (a, b) {
            ...
            var c = new x, d = this;
            Qc(this.__authManager, "unlink", {idToken: this.Ga(), deleteProvider: [a]}, y(c, function (c, f) {
        ...
        E.prototype.cg = function (a, b) {
            ...
            var c = new x;
            Sc(this.__authManager, a, {authType: "link", idToken: this.Ga()}, y(c, b));
            return c.m
        };
        ...
        E.prototype.dg = function (a, b) {
            ...
            Mc("wilddog.auth().signInWithPopup", a);
            var c = new x;
            Tc(this.__authManager, a, {authType: "link", idToken: this.Ga()}, y(c, b));
            return c.m
        };
        ...
        E.prototype.Pg = function (a, b) {
            ...
            var c = new x;
            Nc(this.__authManager, {email: a, idToken: this.Ga()}, y(c, b));
            return c.m
        };
        ...
        E.prototype.Rg = function (a, b) {
            ...
            var c = new x;
            Nc(this.__authManager, {phoneNumber: a, idToken: this.Ga()}, y(c, b));
            return c.m
        };
        ...
        E.prototype.Ug = function (a, b) {
            ...
            var c = new x;
            Uc(this.__authManager, {phoneNumber: this.he(), smsCode: a}, y(c, b));
            return c.m
        };
        ...
        E.prototype.Qg = function (a, b) {
            ...
            var c = new x;
            Nc(this.__authManager, {password: a, idToken: this.Ga()}, y(c, b));
            return c.m
        };
        ...
        E.prototype.sg = function (a) {
            ...
            var b = new x;
            Vc(this.__authManager, {idToken: this.Ga(), requestType: "VERIFY_EMAIL"}, y(b, a));
            return b.m
        };
        ...
        E.prototype.vg = function (a) {
            ...
            var b = new x;
            Wc(this.__authManager, {phoneNumber: this.he(), type: "PHONE_VERIFY"}, y(b, a));
            return b.m
        };
        ...
        function ad(a) {
            var b = {}, c = {}, d = {}, e = "";
            try {
                var f = a.split("."), g = qc(f[0]) || "", k = qc(f[1]) || "", b = Ca(g), c = Ca(k), e = f[2],
                    d = c.d || {};
                delete c.d
            } catch (l) {
                console.warn("error", l)
            }
            return {ah: b, Yd: c, data: d, eh: e}
        }
        ...
        cd.prototype.set = function (a, b) {
            if (!b) if (this.Md.length) b = this.Md[0]; else throw Error("wd.auth.SessionManager : No storage options available!");
            b.set(this.te, a)
        };
        cd.prototype.get = function () {
            var a = bb(this.Md, r(this.Yf, this)), a = ab(a, function (a) {
                return null !== a
            });
            hb(a, function (a, c) {
        ...
        function jd(a) {
            ...
            if (b) {
                var c = v.get("redirect_client_options"), d = ec(["XHR", "JSONP"]);
                serverParams = {requestId: b, requestKey: Ja()};
                transportOptions = {};
        ...
        function Qc(a, b, c, d) {
            var e = {idToken: c.idToken}, f = c.photoURL || a.Qa.currentUser.photoURL,
        ...
        function Rc(a, b) {
            ...
            a.la.emit(a.la.qb.gb, b || {signIn: !1})
        }
        ...
        h.u = function (a) {
            ...
            if (a instanceof H) for (c = a.ba; c < a.A.length; c++) b.push(a.A[c]); else for (a = a.split("/"), c = 0; c < a.length; c++) 0 < a[c].length && b.push(a[c]);
            return new H(b, 0)
        };
        h.f = function () {
        ...
        h.da = function (a) {
            ...
            for (var b = this.ba, c = a.ba; b <= this.A.length; b++, c++) if (this.A[b] !== a.A[c]) return !1;
            return !0
        };
            ...
            if (ha(b)) {
                ...
                qa(b, function (b, g) {
                    if (".value" === b) d = !0; else if (".priority" !== b && ".sv" !== b && (e =
                        !0, !Fd(b))) throw Error(a + " contains an invalid key (" + b + ") " + Cd(c) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
                    c.push(b);
                    Id(a, g, c);
                    c.pop()
                });
        ...
        function Jd(a, b) {
            ...
            for (c = 0; c < b.length; c++) {
                d = b[c];
                for (var e = d.slice(), f = 0; f < e.length; f++) if ((".priority" !== e[f] || f !== e.length - 1) && !Fd(e[f])) throw Error(a + "contains an invalid key (" + e[f] + ") in path " + d.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
            }
            b.sort(H.Yg);
            e = null;
            for (c = 0; c < b.length; c++) {
        ...
        function N(a) {
            ...
            this.Ff = function (a) {
                ...
                return {qc: b[1], gh: b[2], Wg: b[0], zd: "", Xe: "wilddog" !== b[2]}
            ...
            this.app.bind(this.app.qb.Ie, function (a) {
                ...
                c.la.emit(c.la.qb.gb, {signIn: !1, reason: a});
                c.Bb && c.Bb(!1);
                c.lc.clear()
            })
        }
        ...
        N.prototype.tg = function (a, b) {
            ...
            var c = new x;
            Vc(this.ca, {requestType: "RESET_PASSWORD", email: a}, y(c, b));
            return c.m
        };
        ...
        N.prototype.ug = function (a, b) {
            ...
            var c = new x;
            Wc(this.ca, {type: "PASSWORD_RESET", phoneNumber: a}, y(c, b));
            return c.m
        };
        ...
        N.prototype.Lf = function (a, b, c, d) {
            ...
            var e = new x;
            td(this.ca, {phoneNumber: a, password: c, smsCode: b}, y(e, d));
            return e.m
        };
        ...
        N.prototype.Cg = function (a, b) {
            ...
            var c = new x;
            Oc(this.ca, {providerId: "custom", token: a}, y(c, b));
            return c.m
        };
        ...
        N.prototype.Dg = function (a, b, c) {
            ...
            var d = new x;
            Oc(this.ca, {providerId: "password", password: b, email: a}, y(d, c));
            return d.m
        };
        ...
        N.prototype.Eg = function (a, b, c) {
            ...
            var d = new x;
            Oc(this.ca, {providerId: "password", password: b, phoneNumber: a}, y(d, c));
            return d.m
        };
        ...
        N.prototype.Mf = function (a, b, c) {
            ...
            var d = new x;
            qd(this.ca, {email: a, password: b}, y(d, c));
            return d.m
        };
        ...
        N.prototype.Nf = function (a, b, c) {
            ...
            var d = new x;
            qd(this.ca, {phoneNumber: a, password: b}, y(d, c));
            return d.m
        };
        ...
        N.prototype.Fg = function (a, b) {
            ...
            Mc("wilddog.auth().signInWithPopup", a);
            var c = new x;
            Sc(this.ca, a, {authType: "login"}, y(c, b));
            return c.m
        };
        ...
        N.prototype.Gg = function (a, b) {
            ...
            var c = new x;
            Tc(this.ca, a, {authType: "login"}, y(c, b));
            return c.m
        };
        ...
        h.compare = function (a, b) {
            var c = a.node.P(this.bc), d = b.node.P(this.bc), c = c.uc(d);
            return 0 === c ? zc(a.name, b.name) : c
        };
        h.Fc = function (a, b) {
            var c = P(a), c = Q.T(this.bc, c);
            return new O(b, c)
        };
        h.Gc = function () {
        ...
        h = $d.prototype;
        h.compare = function (a, b) {
            var c = a.node.G(), d = b.node.G(), c = c.uc(d);
            return 0 === c ? zc(a.name, b.name) : c
        };
        h.zc = function (a) {
            return !a.G().f()
        ...
        var le = new ge({".priority": Wd}, {".priority": R});
        ...
        h.O = function (a) {
            return a && !this.G().f() ? {".value": this.Ha(), ".priority": this.G().O()} : this.Ha()
        };
        h.hash = function () {
            if (null === this.yb) {
                var a = "";
                this.fa.f() || (a += "priority:" + ne(this.fa.O()) + ":");
                var b = typeof this.I, a = a + (b + ":"), a = "number" === b ? a + Dc(this.I) : a + this.I;
                this.yb = rc(a)
            }
            return this.yb
        };
        ...
        h.uc = function (a) {
            ...
            var b = typeof a.I, c = typeof this.I, d = $a(oe, b), e = $a(oe, c);
        ...
        function te(a, b, c, d, e) {
            this.Fd = e || null;
            this.me = d;
            for (this.Ta = []; !a.f();) if (e = b ? c(a.key, b) : 1, d && (e *= -1), 0 > e) a = this.me ? a.left : a.right; else if (0 === e) {
                this.Ta.push(a);
                break
        ...
        function S(a) {
            ...
            var b = a.Ta.pop(), c;
            c = a.Fd ? a.Fd(b.key, b.value) : {key: b.key, value: b.value};
            if (a.me) for (b = b.left; !b.f();) a.Ta.push(b), b = b.right; else for (b = b.right; !b.f();) a.Ta.push(b), b = b.left;
            return c
        }
        ...
        function ue(a) {
            ...
            b = a.Ta;
            b = b[b.length - 1];
            return a.Fd ? a.Fd(b.key, b.value) : {key: b.key, value: b.value}
        }
        ...
        h.remove = function (a, b) {
            var c, d;
            c = this;
            if (0 > b(a, c.key)) c.left.f() || c.left.ia() || c.left.left.ia() || (c = Ae(c)), c = c.aa(null, null, null, c.left.remove(a, b), null); else {
                c.left.ia() && (c = Be(c));
        ...
        function P(a, b) {
            ...
            if (g) {
                var m = je(f, Xd(R));
                return new T(l, P(c), new ge({".priority": m}, {".priority": R}))
            }
        ...
        function je(a, b, c, d) {
            function e(b, d) {
                ...
                var g = parseInt(f / 2, 10) + b, f = e(b, g), A = e(g + 1, d), g = a[g], k = c ? c(g) : g;
            ...
            var f = function (b) {
                function d(b, d) {
                    var k = L - b, l = L;
                    L -= b;
                    var l = e(k + 1, l), k = a[k], m = c ? c(k) : k, l = new ve(m, k.node, d, null, l);
                    f ? f.left = l : g = l;
                    f = l
                }

                for (var f = null, g = null, L = a.length, A = 0; A < b.count; ++A) {
                    var ca = Me(b), id = Math.pow(2, b.count - (A + 1));
        ...
        var Zd = new Ne, Je = new O("[MIN_NAME]", Q), ee = new O("[MAX_NAME]", Zd);
        ...
        function Te(a, b) {
            ...
            af(a, function (d) {
                ...
                var f = {path: "/.ws", rememberUpgrade: !0};
        ...
        function af(a, b) {
            if (a.F.za) b(a.F.za); else {
                var c = ec(["XHR", "JSONP", "NodeHttp", "WxHttp"]), c = ab(c, function (a) {
                    return "function" === typeof a.isAvailable && a.isAvailable()
                });
        ...
        function bf(a, b, c, d) {
            ...
            df(this, 0);
            Pe.Vb().Ab("visible", this.lg, this);
            -1 === a.host.indexOf("wd.local") && Oe.Vb().Ab("online", this.jg, this)
        }
        ...
        h.Ze = function (a, b, c, d) {
            var e = ff(a), f = a.path.toString();
            this.o("Listen called for " + f + " " + e);
            this.ja[f] = this.ja[f] || {};
            z(!this.ja[f][e], "listen() called twice for same path/queryId.");
            a = {N: d, hd: b, query: a, tag: c};
            this.ja[f][e] = a;
            this.qa && gf(this, a)
        };

        function gf(a, b) {
            var c = b.query, d = c.path.toString(), e = ff(c);
        ...
        function kf(a) {
            var b = a.Ka;
            a.qa && b && a.eb("auth", {cred: b.Pf}, function (c) {
                var d = c.s;
                c = c.d || "error";
        ...
        h.re = function (a, b, c) {
            this.qa ? lf(this, "o", a, b, c) : this.Kc.push({Db: a, action: "o", data: b, N: c})
        };
        h.cf = function (a, b, c) {
            this.qa ? lf(this, "om", a, b, c) : this.Kc.push({Db: a, action: "om", data: b, N: c})
        };
        h.vd = function (a, b) {
            this.qa ? lf(this, "oc", a, null, b) : this.Kc.push({Db: a, action: "oc", data: null, N: b})
        };
        ...
        function mf(a, b, c, d, e, f) {
            d = {p: c, d: d};
            p(f) && (d.h = f);
            a.ta.push({action: b, request: d, N: e});
            a.Oc++;
            b = a.ta.length - 1;
        ...
        function nf(a, b) {
            var c = a.ta[b].action, d = a.ta[b].request, e = a.ta[b].N;
            a.ta[b].ng = a.qa;
            a.eb(c, d, function (d) {
                a.o(c + " response", d);
                delete a.ta[b];
        ...
        function qf(a) {
            if (rf(a)) {
                ...
                a.Bc = null;
                var b = r(a.gg, a), c = r(a.Mc, a), d = r(a.df, a), e = a.id + ":" + ef++;
        ...
        h.Vd = function (a, b) {
            this.Ka = a;
            var c = ad(a), d = c.data, c = c.Yd && c.Yd.exp;
        ...
        function Bf(a, b, c) {
            if (b.f()) a.I = c, a.w = null; else if (null !== a.I) a.I = a.I.K(b, c); else {
                null == a.w && (a.w = new yf);
                var d = J(b);
        ...
        var Gf = new Nf(!0, !1, null, !1), Of = new Nf(!1, !0, null, !1);
        ...
        h.set = function (a, b) {
            ...
            var c = J(a), d = (this.children.get(c) || Sf).set(K(a), b), c = this.children.Sa(c, d);
        ...
        wg.prototype.fb = function (a, b, c, d) {
            var e = new xg, f;
            if (b.type === Kf) b.source.de ? c = yg(this, a, b.path, b.Na, c, d, e) : (z(b.source.Re, "Unknown source."), f = b.source.De, c = zg(this, a, b.path, b.Na, c, d, f, e)); else if (b.type === If) b.source.de ? c = Ag(this, a, b.path, b.children, c, d, e) : (z(b.source.Re, "Unknown source."), f = b.source.De, c = Bg(this, a, b.path, b.children, c, d, f, e)); else if (b.type === Ff) if (b.we) if (f = b.path, null != c.mc(f)) c = a; else {
                b = new ug(c, a, d);
                d = a.J.j();
                if (f.f() || ".priority" === J(f)) a.C().M ? b = c.ya(jg(a)) : (b = a.C().j(), z(b instanceof
                    T, "serverChildren would be complete if leaf node"), b = c.sc(b)), b = this.L.xa(d, b, e); else {
                    f = J(f);
                    var g = c.Za(f, a.C());
            ...
            } else c = Cg(this, a, b.path, c, d, e); else if (b.type === Mf) d = b.path, b = a.C(), f = b.j(), g = b.M || d.f(), c = Dg(this, new gg(a.J, new eg(f, g, b.Sb)), d, c, tg, e); else throw pc("Unknown operation type: " + b.type);
            e = qb(e.kb);
            d = c;
            b = d.J;
        ...
        function Dg(a, b, c, d, e, f) {
            ...
            var k;
            if (c.f()) z(b.C().M, "If change path is empty, we must have complete server data"), b.C().Sb ? (e = jg(b), d = d.sc(e instanceof T ? e : Q)) : d = d.ya(jg(b)), f = a.L.xa(b.J.j(), d, f); else {
                var l = J(c);
                if (".priority" == l) z(1 == xd(c), "Can't have a priority with additional path components"), f = g.j(), k = b.C().j(), d = d.Wc(c, f, k), f = null != d ? a.L.ga(f, d) : g.j(); else {
                    var m = K(c);
        ...
        function zg(a, b, c, d, e, f, g, k) {
            var l = b.C();
            g = g ? a.L : a.L.Ub();
            if (c.f()) d = g.xa(l.j(), d, null); else if (g.La() && !l.Sb) d = l.j().K(c, d), d = g.xa(l.j(), d, null); else {
                var m = J(c);
        ...
        function yg(a, b, c, d, e, f, g) {
            var k = b.J;
            e = new ug(e, b, f);
            if (c.f()) g = a.L.xa(b.J.j(), d, g), a = hg(b, g, !0, a.L.La()); else if (f = J(c), ".priority" === f) g = a.L.ga(b.J.j(), d), a = hg(b, g, k.M, k.Sb); else {
                var l = K(c);
                c = k.j().P(f);
                if (!l.f()) {
                    var m = e.Se(f);
        ...
        function Cg(a, b, c, d, e, f) {
            if (null != d.mc(c)) return b;
            var g = new ug(d, b, e), k = e = b.J.j();
            if (b.C().M) {
                if (c.f()) e = d.ya(jg(b)), k = a.L.xa(b.J.j(), e, f); else if (".priority" === J(c)) {
                    var l = d.Za(J(c), b.C());
        ...
        function Fg(a, b) {
            this.X = a;
            var c = a.B, d = new Gg(c.g), c = uf(c) ? new Gg(c.g) : c.oa ? new Hg(c) : new Ig(c);
            this.kf = new wg(c);
            var e = b.C(), f = b.J, g = d.xa(Q, e.j(), null), k = c.xa(Q, f.j(), null);
        ...
        h.nb = function (a, b) {
            ...
            if (a) {
                for (var e = [], f = 0; f < this.ab.length; ++f) {
                    var g = this.ab[f];
                    if (!g.matches(a)) e.push(g); else if (a.Ve()) {
        ...
        h.Cd = function (a) {
            ...
            if (d) {
                if (e) this.V = Zg(this.Ea, $g, M), this.Cc = 0 < this.Ea.length ? this.Ea[this.Ea.length - 1].Td : -1; else if (c.Na) this.V = this.V.Cd(c.path); else {
                    var k = this;
        ...
        function Zg(a, b, c) {
            for (var d = Qg, e = 0; e < a.length; ++e) {
                ...
                if (b(f)) {
                    var g = f.path;
                    if (f.Na) c.contains(g) ? (g = I(c, g), d = Rg(d, g, f.Na)) : g.contains(c) && (g = I(g, c), d = Rg(d, M, f.Na.sa(g))); else if (f.children) if (c.contains(g)) g = I(c, g), d = Sg(d, g, f.children); else {
                        if (g.contains(c)) if (g = I(g, c), g.f()) d = Sg(d, M, f.children); else if (f = t(f.children, J(g))) f = f.sa(K(g)), d = Rg(d, M, f)
        ...
        function ch(a, b, c, d, e) {
            ...
            p(g) || (g = !0);
            f.Ea.push({path: b, Na: c, Td: d, visible: g});
            g && (f.V = Rg(f.V, b, c));
            f.Cc = d;
        ...
        function eh(a, b, c, d) {
            ...
            e.Ea.push({path: b, children: c, Td: d, visible: !0});
            e.V = Sg(e.V, b, c);
            e.Cc = d;
            c = Rf(c);
        ...
        bh.prototype.nb = function (a, b, c) {
            ...
            if (e && ("default" === ff(a) || null != Og(e, a))) {
                ...
                if (b && !g && (d = this.wa.subtree(d), !d.f())) for (var d = ph(d), k = 0; k < d.length; ++k) {
                    var l = d[k], m = l.X, l = qh(this, l);
                    this.Dc.ye(m, rh(this, m), l.hd, l.N)
                }
                if (!g && 0 < e.length && !c) if (b) this.Dc.Ld(a, null); else {
                    var L = this;
                    ta(e, function (a) {
                        ff(a);
                        var b = L.jc[mh(a)];
        ...
        bh.prototype.ya = function (a, b) {
            var c = this.Eb, d = Yf(this.wa, a, function (b, c) {
                var d = I(b, a);
        ...
        function oh(a, b, c) {
            ...
            d = a.wa.subtree(d);
            if (e) z(null == Mg(d.value), "If we're adding a query, it shouldn't be shadowed"); else for (e = Wf(d, function (a, b, c) {
        ...
        function jh(a) {
            ...
            return {Fb: a.substr(b + 1), path: new H(a.substr(0, b))}
        }
        ...
        function th(a, b, c, d, e) {
            ...
            var g = [], k = J(b.path), l = b.Nc(k);
            if ((c = c.children.get(k)) && l) var m = d ? d.P(k) : null, k = e.u(k), g = g.concat(th(a, l, c, m, k));
        ...
        function uh(a, b, c, d, e) {
            ...
            c.children.na(function (c, f) {
                var k = d ? d.P(c) : null, l = e.u(c), A = b.Nc(c);
        ...
        wh.prototype.get = function () {
            var a = this.Jf.get(), b = xb(a);
            if (this.od) for (var c in this.od) b[c] -= this.od[c];
            this.od = a;
            return b
        };
        ...
        function Hh(a, b) {
            for (var c = b instanceof H ? b : new H(b), d = a, e; null !== (e = J(c));) var f = t(d.H.children, e) || new Fh, d = new Gh(e, d, f), c = K(c);
            return d
        }
        ...
        function Jh(a) {
            if (null !== a.Ba) {
                var b = a.Ba, c = a.sd, d = a.f(), e = pa(b.H.children, c);
        ...
        function Th(a, b, c) {
            a.Bb(!1);
            "expired_token" == b && a.la.emit(a.la.qb.Ie, {status: b, reason: c})
        }
        ...
        h.ob = function (a, b, c, d) {
            this.o("set", {path: a.toString(), value: b, bh: c});
            var e = Wh(this);
            b = P(b, c);
            var e = Eh(b, e), f = this.td++, e = ch(this.S, a, e, f, !0);
            Nh(this.ha, e);
            var g = this;
        ...
        h.update = function (a, b, c) {
            this.o("update", {path: a.toString(), value: b});
            var d = !0, e = Wh(this), f = {};
            w(b, function (a, b) {
                d = !1;
                var c = P(a);
            ...
            if (d) Ra("update() called with empty data.  Don't do anything."), Zh(c, "ok"); else {
                var g = this.td++, k = eh(this.S, a, f, g);
                Nh(this.ha, k);
                var l = this;
                this.ka.af(a.toString(), b, function (b, d) {
                    var e = "ok" === b;
                    e || B("update at " + a + " failed: " + b);
                    var e = fh(l.S, g, !e), f = a;
                    0 < e.length && (f = Xh(l, a));
                    Rh(l.ha, f, e);
                    Zh(c, b, d)
                });
        ...
        function ci(a, b, c, d) {
            ...
            e ? (Ra("onDisconnect().update() called with empty data.  Don't do anything."), Zh(d, "ok")) : a.ka.cf(b.toString(), c, function (e, f) {
                if ("ok" === e) for (var g in c) if (c.hasOwnProperty(g)) {
                    var k = P(c[g]);
                    Bf(a.Aa, b.u(g), k)
                }
                Zh(d, e, f)
        ...
        function fi(a, b, c, d, e) {
            ...
            g.Ab("value", f);
            c = {
                path: b, update: c, N: d, status: null, order: oc(), He: e, rf: 0, Qd: function () {
                    g.fc("value", f)
                }, Ud: null, Fa: null, $c: null, ad: null, bd: null
            };
            d = a.S.ya(b, void 0) || Q;
            c.$c = d;
            d = c.update(d.O());
        ...
        function ji(a, b, c) {
            for (var d = bb(c, function (a) {
                ...
                g.status = 2;
                g.rf++;
                var k = I(b, g.path), d = d.K(k, g.ad)
            }
            var d = d.O(!0), l = a.la;
            a.ka.put(b.toString(), d, function (d) {
                a.o("transaction put response", {path: b.toString(), status: d});
                var e = [];
                if ("ok" === d) {
                    d = [];
                    ...
                    if ("datastale" === d) for (f = 0; f < c.length; f++) c[f].status = 4 === c[f].status ? 5 : 1; else for (B("transaction at " + b.toString() + " failed: " + d), f = 0; f < c.length; f++) c[f].status = 5, c[f].Ud = d;
                    Xh(a, b)
                }
            }, e)
        }
        ...
        function Xh(a, b) {
            var c = ki(a, b), d = c.path(), c = ii(a, c);
            li(a, c, d);
            return d
        }
        ...
        function li(a, b, c) {
            if (0 !== b.length) {
                for (var d = [], e = [], f = bb(b, function (a) {
                    ...
                    var k = b[g], l = I(c, k.path), m = !1, L;
                    z(null !== l, "rerunTransactionsUnderNode_: relativePath should not be null.");
                    if (5 === k.status) m = !0, L = k.Ud, e = e.concat(fh(a.S, k.Fa, !0)); else if (1 === k.status) if (25 <= k.rf) m = !0, L = "maxretry", e = e.concat(fh(a.S, k.Fa, !0)); else {
        ...
        function ni(a, b) {
            var c = b.Ha();
            if (null !== c) {
                for (var d = [], e = [], f = -1, g = 0; g < c.length; g++) 4 !== c[g].status && (2 === c[g].status ? (z(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].Ud = "set") : (z(1 === c[g].status, "Unexpected transaction status in abort"), c[g].Qd(), e = e.concat(fh(a.S, c[g].Fa, !0)), c[g].N && d.push(r(c[g].N, null, Error("set"), !1, null))));
                -1 === f ? Ih(b, null) : c.length = f + 1;
                Rh(a.ha, b.path(), e);
                for (g = 0; g < d.length; g++) Fc(d[g])
            }
        };
        ...
        pi.prototype.wd = function (a) {
            ...
            c && "request" === c.a && (Ia(window, this.wd), this.Nd = a.origin, this.jb && setTimeout(function () {
                b.jb(b.Nd, c.d, function (a, c) {
                    b.Gf = !c;
                    b.jb = void 0;
                    qi(b, {a: "response", d: a, forceKeepWindowOpen: c})
                })
            }, 0))
        };
        pi.prototype.kg = function () {
            ...
            this.jb && (qi(this, {a: "error", d: "unknown closed window"}), this.jb = void 0);
            try {
                window.close()
            } catch (a) {
            }
        ...
        h.xa = function (a, b, c) {
            b.R() && (b = Q);
            var d = b.pb(this.g), d = d.ga(Q), e = this;
            b.W(R, function (a, b) {
        ...
        h.xa = function (a, b, c) {
            var d;
            if (b.R() || b.f()) d = Q.pb(this.g); else if (2 * this.ea < b.zb() && b.Ac(this.g)) {
                d = Q.pb(this.g);
                b = this.Gb ? b.Zb(this.va.xc, this.g) : b.Xb(this.va.Rc, this.g);
                for (var e = 0; 0 < b.Ta.length && e < this.ea;) {
                    var f = S(b), g;
                    if (g = this.Gb ? 0 >= this.g.compare(this.va.Rc, f) : 0 >= this.g.compare(f, this.va.xc)) d = d.T(f.name, f.node), e++; else break
                }
            } else {
                d = b.pb(this.g);
                d = d.ga(Q);
        ...
        function xi(a, b, c, d, e, f) {
            ...
            z(b.zb() == a.ea, "");
            var l = new O(c, d), m = a.Gb ? He(b, a.g) : Ie(b, a.g), L = a.va.matches(l);
            if (b.Ma(c)) {
                var A = b.P(c), m = e.ee(a.g, m, a.Gb);
        ...
        function ri(a, b) {
            ...
            if (e) {
                var f = e.type;
                if ("child_added" == c && "child_removed" == f) a.kb[d] = new V("child_changed", b.Oa, d, e.Oa); else if ("child_removed" == c && "child_added" == f) delete a.kb[d]; else if ("child_removed" == c && "child_changed" == f) a.kb[d] = new V("child_removed", e.qe, d); else if ("child_changed" == c &&
                    "child_added" == f) a.kb[d] = new V("child_added", b.Oa, d); else if ("child_changed" == c && "child_changed" == f) a.kb[d] = new V("child_changed", b.Oa, d, e.qe); else throw pc("Illegal combination of changes: " + b + " occurred after " + e);
            } else a.kb[d] = b
        };
        ...
        Z.prototype.Ab = function (a, b, c, d) {
            ...
            if ("value" === a) di(this.D, this, new mg(b, e.cancel || null, e.context || null)); else {
                var f = {};
                f[a] = b;
        ...
        Z.prototype.ef = function (a, b, c, d) {
            ...
            Md("Query.once", a, !1);
            G("Query.once", 2, b, !0);
            var f = Fi("Query.once", c, d), g = this, k = !0, l = new x;
            bc(l.m);
        ...
        function Fi(a, b, c) {
            ...
            if (b && c) d.cancel = b, G(a, 3, d.cancel, !0), d.context = c, vd(a, 4, d.context); else if (b) if ("object" === typeof b && null !== b) d.context = b; else if ("function" === typeof b) d.cancel = b; else throw Error(ud(a, 3, !0) + " must either be a cancel callback or a context object.");
            return d
        };
        ...
        W.prototype.push = function (a, b) {
            ...
            var c = Vh(this.D), d = Hi(c), c = this.u(d);
            if (null != a) {
        ...
        (function (a) {
            ...
            [{id: "password", name: "Wilddog", rb: "phoneOrEmail", Ya: "password"}, {
                id: "password",
                name: "Email",
                rb: "email",
                Ya: "password"
            }, {id: "qq", name: "QQ", rb: "accessToken", Ya: "openId"}, {
                id: "weibo",
                name: "Weibo",
                rb: "accessToken",
                Ya: "openId"
            }, {id: "weixin", name: "Weixin", rb: "accessToken", Ya: "openId"}, {
                id: "weixinmp",
                name: "Weixinmp",
                rb: "accessToken",
                Ya: "openId"
        ...
        if ("WEB" == CLIENT_TYPE) "object" == typeof module && module.exports && (module.exports = Sd), "function" == typeof define && define.amd && define("wilddog", [], function () {
            return Sd
        }), "undefined" != typeof window ? window.wilddog = Sd : WorkerGlobalScope && self && (self.wilddog = Sd); else if ("NODE" == CLIENT_TYPE || "WX" == CLIENT_TYPE || "RN" == CLIENT_TYPE) module.exports = Sd;
    };
